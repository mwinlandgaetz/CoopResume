...
\section{Competencies}
    ...
    \begin{itemize} \itemsep -2pt
        ...
        \item Developed several applications in \textbf{Python and C/\CC} for personal use, and am currently learning \textbf{Rust}.
        ...
        \item Maintained version tracking and documentation through \textbf{Github} and \textbf{Bitbucket}, to facilitate effective and transparent collaboration with other employees.
    \end{itemize}
    \textbf{Core}
    \begin{itemize} \itemsep -2pt
...
\section{Professional Experience}
    ...
    \begin{itemize}  \itemsep -2pt
        \item Developed an integrated data capture, storage, and graphing application using Python (with PyQt) and SQLite, which directly contributed to the detection and resolution of several mission-critical bugs prior to station deployment.
        \item Compiled an exhaustive feasibility study for a 100VDC power distribution system redesign to be implemented in the Pacific Ocean Neutrino Experiment, including extensive component research, circuit design and multi-board modelling in Altium Designer, and transient analysis using LTSpice.
        \item Utilized a number of industrial communication protocols in my software and firmware projects for interfacing with in-house and proprietary devices, including \textbf{SPI, Telnet, RS-485, and MQTT}.
